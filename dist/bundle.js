...
const domModule = (function () {
    ...
    const updateTodos = (todosDb, projectsDb, isCondition) => {
        ...
        todosDb.forEach(todo => {
            ...
            date.textContent = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(new Date(currentTodo._dueDate), 'PPPPpp')
